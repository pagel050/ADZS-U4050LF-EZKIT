...
===========  a CRC value using data stored in a buffer and compares the result 
             ...
             The CRC driver is statically configured to execute in core-driven
             CRC operations. (See adi_crc_config.h)
...
=========    It opens a CRC device, configures this device to calculate the
             ...
             This example executes core-driven CRC operations.
...
==========================
           ...
           This example requires ADI_CRC_CFG_ENABLE_DMA_SUPPORT set to 0.
           ADI_CFG_CRC_SOFTWARE_DMA_CHANNEL_ID is not needed.
