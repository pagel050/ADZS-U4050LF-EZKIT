...
=====================
	...
	Note: The project has to be run to completion, indicated by "all done!". If the project run
		  is stopped midway, then SYSTEM RESET/POWER CYCLE is required to reset the adxl363.
